                    ...
                    <div id="form-create-guide">
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title"><b>Buat Publikasi</b></h3>
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form action="<?=base_url();?>admin/C_publicationController/store" method="post" enctype="multipart/form-data">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="create_name" name="name" placeholder="Masukan Judul" required>
                                </div>
                                <div class="form-group">
