                        ...
                        <tr>
                            ...
                            <td>
                              <?php if ($_SESSION['name'] == $list->name) { ?>
                                ...
                                <a href="<?=base_url();?>user/<?php echo $list->id ?>/edit" class="btn <?php echo ($this->uri->segment(2, 0) == $list->id ? 'btn-secondary' : 'btn-outline-secondary'); ?> btn-sm">Ubah</a>
            ...
            <div id="form-edit-user">
              <div class="card card-warning">
                <div class="card-header">
                  <h3 class="card-title" style="color: white;"><b>Ubah Pengguna</b></h3>
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form action="<?=base_url();?>admin/C_usersController/update/<?php echo $user[0]->id ?>" method="post">
                  <div class="card-body">
                    <div class="form-group">
                      <label for="name">Nama</label>
                      <input type="text" class="form-control" id="name" name="name" placeholder="Masukan Nama" value="<?php echo $user[0]->name ?>">
                    </div>
                    <div class="form-group">
                      <label for="email">Email</label>
                      <input type="email" class="form-control" id="email" name="email" placeholder="Masukan Email" value="<?php echo $user[0]->email ?>">
                    </div>
                    <div class="form-group">
                  ...
                  <div class="card-footer">
                    <button type="submit" class="btn btn-warning" style="color: white;"><b>Ubah</b></button>
                  </div>
                </form>
              </div>
            </div>
