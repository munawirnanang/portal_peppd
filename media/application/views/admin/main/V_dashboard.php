        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              ...
              <div class="icon" style="top: 0; left: 100%;">
          ...
          <section class="col-lg-5 connectedSortable">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <div class="tab-content p-0">
                  <!-- Morris chart - Sales -->
                  <div class="chart tab-pane active" id="by-article-chart" style="position: relative; height: 400px; overflow-y: auto;">
                          ...
                          <tr>
                            ...
                            <td>
                              <?php 
                                ...
                                $count_per_month = $db->query("SELECT COUNT(*) AS jumlah FROM `log_portals` WHERE action LIKE 'user mengklik article dengan id = ".$article->id."%' AND created_at IS NOT NULL")->result();
                                echo $count_per_month[0]->jumlah;
                              ?>
                            </td>
                          </tr>
                        <?php $no++; } ?>
      ...
      <?php foreach ($articles as $article) { ?>
        {
            ...
            [
              <?php 
                $db = $this->load->database('default', TRUE);
                $count_per_month = $db->query("SELECT SUBSTRING(`created_at`, 1, 7) as tanggal, COUNT(*) AS jumlah FROM `log_portals` WHERE action LIKE 'user mengklik article dengan id = ".$article->id."%' AND created_at IS NOT NULL GROUP BY SUBSTRING(`created_at`, 1, 7) ORDER BY created_at DESC LIMIT 12")->result();
              ?>
              <?php 
                $i = count($count_per_month)-1;
                while ( 0 <= $i ) {
                  echo $count_per_month[$i]->jumlah.', ';
                  $i--;
                } 
              ?>
            ]
