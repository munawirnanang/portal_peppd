    ...
    <section class="content">
      <div class="container-fluid" style="width: 85%;">
        ...
        <div class="card">
            ...
            <form action="<?=base_url();?>admin/C_articlesController/update" method="post" enctype="multipart/form-data">
                <div class="card-body">
                    <div class="row">
                    <input type="hidden" class="form-control" id="create_slug" name="slug" placeholder="Enter Slug" value="<?php echo $article[0]->slug ?>" required>
                        <div class="col-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="create_title" name="title" placeholder="Masukan Judul" value="<?php echo $article[0]->title ?>" required>
                            </div>
                            <div class="form-group">
                                <label for="create_description">Keterangan</label>
                                <textarea class="form-control" id="create_description" name="description" rows="3"><?php echo $article[0]->description ?></textarea>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <?php if($article[0]->title_picture == NULL) { ?>
                                    <img id="preview_create_title_picture" alt="">
                                <?php }else{ ?>
                                    <img id="preview_create_title_picture" src="<?=base_url();?>assets/images/summernote/<?php echo $article[0]->title_picture ?>" alt="<?php echo $article[0]->title_picture ?>" class="img-thumbnail" style="max-height: 200px; margin-top: 10px;">
                                <?php } ?>
                            </div>
                            <div class="form-group">
                              <label>Tanggal Publish</label>
                              <!-- <?php echo $article[0]->created_at ?><br/>
                              Date: <?php echo substr($article[0]->created_at, 0, 10) ?><br/>
                              Time: <?php echo substr($article[0]->created_at, 11) ?><br/> -->
                              <input type="datetime-local" id="create_created_at" name="created_at" value="<?php echo substr($article[0]->created_at, 0, 10) ?>T<?php echo substr($article[0]->created_at, 11) ?>" required>
                            </div>
                        </div>
                    </div>
                    <div class="form-group col-12">
                        <label for="create_text">Konten</label>
                        <textarea id="create_article_summernote" name="text"><?php echo $article[0]->text ?></textarea>
                    </div>
                </div>
